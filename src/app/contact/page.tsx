      ...
      <div className="relative flex h-auto min-h-screen w-full flex-col overflow-x-hidden">
        <main className="flex-1 w-full max-w-[1200px] mx-auto px-6 lg:px-20 py-8 lg:py-12">
          <nav className="flex flex-wrap gap-2 pb-6 text-sm">
            <Link className="text-gray-500 dark:text-gray-400 font-medium hover:text-gray-700 transition-colors" href="/">
              Home
            </Link>
            <span className="text-gray-400 dark:text-gray-500 font-medium">/</span>
            <span className="text-gray-900 dark:text-gray-200 font-medium">Contact</span>
          </nav>
          <div className="flex flex-wrap justify-between gap-6 pb-10 border-b border-gray-200 dark:border-gray-800 mb-10">
            <div className="flex max-w-3xl flex-col gap-3">
              <h1 className="text-gray-900 dark:text-white text-4xl lg:text-5xl font-black leading-tight tracking-[-0.033em]">Contact Editorial Team</h1>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
            ...
            <aside className="lg:col-span-4 flex flex-col gap-8">
              <div className="bg-white dark:bg-[#1a202c] p-6 rounded-lg border border-gray-200 dark:border-gray-800 shadow-sm">
              ...
              <div className="pt-4 border-t border-gray-200 dark:border-gray-800">
                ...
                <div className="flex items-center gap-3">
                  <a
                    aria-label="LinkedIn"
                    className="flex items-center justify-center size-10 rounded bg-gray-100 dark:bg-gray-800 text-gray-600 dark:text-gray-400 hover:bg-gray-800 hover:text-white transition-all"
                    href="#"
                  >
