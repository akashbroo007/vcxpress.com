          ...
          <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-6">
            <div className="max-w-2xl">
              <div className="flex items-center gap-2">
                ...
                <span className="text-gray-500 text-xs font-semibold tracking-widest uppercase font-mono">Support</span>
              </div>
            ...
            <div className="w-full lg:w-[420px]">
              <div className="flex items-center h-11 w-full bg-surface-light dark:bg-surface-dark rounded border border-gray-200 dark:border-gray-800 focus-within:border-gray-400 focus-within:ring-1 focus-within:ring-gray-400/20 transition-all">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
            <div className="lg:col-span-8">
              ...
              <div className="mt-6 space-y-4">
                <div className="rounded-lg border border-gray-200 dark:border-gray-800 bg-surface-light dark:bg-surface-dark p-5">
                ...
                <div className="rounded-lg border border-gray-200 dark:border-gray-800 bg-surface-light dark:bg-surface-dark p-5">
                  ...
                  <div className="mt-3 flex flex-wrap gap-3">
                    <Link className="text-xs font-mono uppercase tracking-wider text-gray-600 hover:text-gray-800 hover:underline" href="/privacy">
                      Privacy
                    </Link>
                    <Link className="text-xs font-mono uppercase tracking-wider text-gray-600 hover:text-gray-800 hover:underline" href="/cookies">
                      Cookies
                    </Link>
                    <Link className="text-xs font-mono uppercase tracking-wider text-gray-600 hover:text-gray-800 hover:underline" href="/terms">
                      Terms
                    </Link>
                  </div>
                </div>
            ...
            <aside className="lg:col-span-4">
              <div className="rounded-xl border border-gray-200 dark:border-gray-800 bg-surface-light dark:bg-surface-dark p-6">
                ...
                <div className="mt-4 flex flex-col gap-3">
                  <Link className="flex items-center justify-between rounded-lg border border-gray-200 dark:border-gray-800 px-4 py-3 hover:border-gray-400 transition-colors" href="/contact">
                  ...
                  <Link className="flex items-center justify-between rounded-lg border border-gray-200 dark:border-gray-800 px-4 py-3 hover:border-gray-400 transition-colors" href="/news">
                    <span className="text-sm font-semibold">Browse latest news</span>
                    <span className="material-symbols-outlined text-[18px] text-text-subtle">arrow_forward</span>
                  </Link>
                  <Link className="flex items-center justify-between rounded-lg border border-gray-200 dark:border-gray-800 px-4 py-3 hover:border-gray-400 transition-colors" href="/sitemap">
